        ...
        if(pieza==2 and tablero[inicio][inicio2] != 0 ):
           ...
           while (reiniciar==0):
              ...
              if(tablero[filam][columnam]!=0 or(filam==5 and columnam==5)):
                 print("las piezas muertas solo pueden ocupar lugares vacios o no pueden ocupar el centro")     
           if(temporal%10==0):      
        ...
        if(pieza==4 and tablero[inicio][inicio2] != 0):
           ...
           while (reiniciar==0):
              ...
              if(tablero[filam][columnam]!=0 or (filam==5 and columnam==5 and int((temporal%100)/10)!= 5)):
                 print("las piezas solo pueden ocupar lugares vacios o no pueden ocupar el centro si son un lider")
                 reiniciar=0
